        ...
        <header>
                <nav>
                    ...
                    <div className='headerItems'>
                        <p><a className="nav-link active aboutLink" href="#about">About</a></p>
                        <p><a className="nav-link" href="#portfolio">Portfolio</a></p>
                        <p><a className="nav-link" href="#contact">Contact</a></p>
                    </div>
